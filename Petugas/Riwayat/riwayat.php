...
<html lang="en">
  ...
  <div class="container mt-5 pt-5 body">
    <div class="container mt-3">
      <div class="row">
        <div class="col mb-4">
            <div class="card" style="background-color: #82D19B;">
              <h5 class="card-title m-3 ">Laporan Diterima</h5>
              <div class="row no-gutters">
                <div class="p-4 text-end">
                  <a href="riwayat_diterima.php" class="btn" style="background-color: white;">Lihat Selengkapnya</a>
                </div>
              </div>
            </div>
          </a>
      ...
      <div class="row">
        <div class="col mb-4">
            <div class="card" style="background-color: #82D19B;">
              <h5 class="card-title m-3">Laporan Ditolak</h5>
              <div class="row no-gutters">
                <div class="p-4 text-end">
                  <a href="riwayat_ditolak.php" class="btn" style="background-color: white;">Lihat Selengkapnya</a>
                </div>
              </div>
            </div>
          </a>
