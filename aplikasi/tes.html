...
<body>
    ...
    <div class="gambar text-center py-4">
        <img src="assets/orang.png" draggable="false" width="246" height="246">
        <p class="px-5">Hai, Selamat Datang di Aplikasi Trashdeep<p></p></p>
    </div>

    <div class="tombol text-center">
  
        <a href="login.php"><button type="button" class="btn-user">User</button></a><br>
        <a href="daftar.html"><button type="button" class="btn-admin">Admin</button></a><br>
    </div>
